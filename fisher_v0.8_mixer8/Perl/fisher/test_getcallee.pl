...
my %sidtbl = ();
my $tdyrec_qry   = "c:/cygwin/usr/local/src/ctscol/fisher_v0.8/Perl/fisher/tdyrecs.sql";
$/ = undef;
...
my $fullpool_qry = "c:/cygwin/usr/local/src/ctscol/fisher_v0.8/Perl/fisher/testgetcallee.sql";
my $ldcpool_qry  = "c:/cygwin/usr/local/src/ctscol/fisher_v0.8/Perl/fisher/getcleldc.sql";
my $qry = undef;
