...
$ENV{'FUNCDIR'}      = 'd:\fisher_v0.5\Function';
$ENV{'INCDIR'}       = 'd:\fisher_v0.5\Include';
$ENV{'PARDIR'}       = 'd:\vos6w\cfg';
$ENV{'TRACEAPI'}     = 'YES';
$ENV{'TRACEONENTRY'} = 'YES';
$ENV{'VOSFONTNAME'}  = 'Courier New';
$ENV{'VOSFONTSIZE'}  = '12';
$ENV{'VOSLOGDIR'}    = 'p:\proc';
$ENV{'VOSNODIALOGS'} = 'YES';
$ENV{'VOSNOSPLASH'}  = 'YES';
$ENV{'VXDIR'}        = 'd:\fisher_v0.5\Bin';

my $evlh = Win32::EventLog->new("fisher_v0.5");
my $vosexe = 'C:\WINNT\system32\vos6w.exe';
...
Win32::Process::Create($vosrt,
		       ...
		       0,
		       HIGH_PRIORITY_CLASS,
		       'd:\fisher_v0.5\bin') || die erpt("Failed to start vos6wd");
